...
var Model;
function GetModel(Model_Property) {
...
function ShowToolTip() {
    ...
    $(".kIcon.k-icon.k-i-excel").parent().attr("title", "Download Sample");
    $(".k-icon.k-i-change-manually").parent().attr("title", "View Contract Rate Card");
    $(".kIcon.kdelete").parent().attr("title", "Delete");
    $(".ActionIconDelete").parent().attr("title", "Delete");
    $(".kIcon.ActionIconValidate").parent().attr("title", "Validate");
    $(".kIcon.ActionIconDownload").parent().attr("title", "Download");              
    $(".kIcon.ActionIconProceed").parent().attr("title", "Process");
    $(".kIcon.ActionIconReset").parent().attr("title", "Reset");
    $(".kIcon.ActionIconuarrow").parent().attr("title", "Up");
    $(".kIcon.ActionIcondarrow").parent().attr("title", "Down");
    $(".kIcon.ActionIconDeleteRed").parent().attr("title", "Delete");
    ...
    $(".kIcon.k-icon.k-i-excel").parent().kendoTooltip({
        width: 60,
        position: "top"
    }).data("kendoTooltip");
    ...
    //
    $(".ActionIconDelete").parent().kendoTooltip({
        width: 60,
        position: "top"
    }).data("kendoTooltip");
    //ActionIconDeleteRed
    $(".ActionIconDeleteRed").parent().kendoTooltip({
        width: 60,
        position: "top"     
    }).data("kendoTooltip");

    $(".kIcon.ActionIconValidate").parent().kendoTooltip({
        width: 60,
        position: "top"
    }).data("kendoTooltip");
    $(".kIcon.ActionIconDownload").parent().kendoTooltip({
        width: 60,
        position: "top"
    }).data("kendoTooltip");  
    $(".kIcon .ActionIconProceed").parent().kendoTooltip({
        width: 60,
        position: "top"
    }).data("kendoTooltip");
    $(".kIcon.ActionIconReset").parent().kendoTooltip({
        width: 60,
        position: "top"
    }).data("kendoTooltip");

    $(".kIcon.ActionIconDeleteRed").parent().kendoTooltip({
        width: 60,
        position: "top"
    }).data("kendoTooltip");
    $(".kIcon.ActionIconuarrow").parent().kendoTooltip({
        width: 60,
        position: "top"
    }).data("kendoTooltip");
    $(".kIcon.ActionIcondarrow").parent().kendoTooltip({
        width: 60,
        position: "top"
    }).data("kendoTooltip");
}
