...
$(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.IsSuccess) {
                    ...
                    if (response.Data == "-1") {
                        $("#spnError").html("User not authorized.");
                        OpenModal("dvError", 900, "File Meta Data");
                    }
                    else if (response.Data == "-2") {
                        $("#spnError").html("This folder not exists.");
                        OpenModal("dvError", 900, "File Meta Data");
                    }
                }
            },
    ...
    $("#dvOpen").bind('click', function () {
        ...
        if (dbConnObj != undefined) {
            ...
            if (dataItem != undefined) {
                ...
                $("#spnError").html("Please select folder");
                OpenModal("dvError", 900, "File Meta Data");
            }
        }
    });
        ...
        if (dataitem.id != 0) {
            ...
            $('#btnRename').unbind().bind('click', function () {
                ...
                if (OldName != NewFile) {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response.IsSuccess) {
                                ...
                                if (response.Data == "-3") {
                                    $("#spnError").html("This folder already exists.");
                                    OpenModal("dvError", 900, "File Meta Data");
                                }
                                else if (response.Data == "-2") {
                                    $("#spnError").html("This folder not exists.");
                                    ...
                                    $("#spnError").html("Access Denied, You don't have permission to rename folder/files on this folder.");
                                    OpenModal("dvError", 900, "File Meta Data");
                                }
                            }
                        },
                    ...
                    $("#spnError").html("File name and new file name do not same.");
                    OpenModal("dvError", 900, "File Meta Data");
                }
            });
        }
    ...
    $("#dvViewFile").click(function () {
        ...
        if (dbConnObj != undefined) {
            ...
            if (dataItem != undefined) {
                ...
                $("#spnError").html("Please select File.");
                OpenModal("dvError", 900, "File Meta Data");
            }
        }
    });
        ...
        if (originalFileName != "" && arrMsg.length == 0) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.IsSuccess) {
                        if (response.Data > 0) {
                            $("#spnSucess").html("File created successfully");
                            OpenModal("dvSucess", 900, "File Meta Data");
                        ...
                        if (response.Data == "-1") {
                            ...
                            $("#spnError").html("Please upload file then process.");
                            OpenModal("dvError", 900, "File Meta Data");
                        }
        ...
        if (dbConnObj != undefined) {
            ...
            if (dataitem != undefined) {
                if (dataitem.FileType == 'Folder') {
                    ...
                    $("#spnError").html("Only folder allow.");
                    OpenModal("dvError", 900, "File Meta Data");
                }
            }
            else {
            ...
            $("#spnError").html("Please select node.");
            OpenModal("dvError", 900, "File Meta Data");
        }
    });
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.IsSuccess) {
                        ...
                        if (response.Data == "-3") {
                            $("#spnError").html("Access Denied, You don't have permission to create folder on this folder.");
                            OpenModal("dvError", 900, "File Meta Data");
                        }
                        else {
                            $("#spnError").html("This folder already exist.");
                            OpenModal("dvError", 900, "File Meta Data");
                        }
                    }
                },
    ...
    $("#dvDelete").click(function () {
        ...
        if (!dataitem.hasChildren) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.IsSuccess) {
                            ...
                            if (response.Data == "-3") {
                                $("#spnError").html("Access Denied, You don't have permission to delete folder/files on this folder.");
                                OpenModal("dvError", 900, "File Meta Data");
                            }
            ...
            $("#spnError").html("Folder can not be deleted. please delete file and folder first.");
            OpenModal("dvError", 900, "File Meta Data");
        }
    });
            ...
            $.get(GetAcessRoleForFileExplorerURL, { FileID: FileID }, function (response) {
                if (response.IsSuccess) {
                    ...
                    var columns = [
                        ...
                        { field: "ROLENAME", title: "ROLENAME", filterable: { multi: true, search: true } },
                        { field: "IsView", title: "View",type: 'boolean', filterable: false, template: "<input key='IsView' type=\"radio\" name=#= UID #   #= IsView ? checked='checked' : '' #  value='1' class=\"IsViewcheck_row check_row\" />" },
                        { field: "IsALL", title: "All", type: 'boolean', filterable: false, template: "<input key='IsALL' type=\"radio\" name=#= UID #   #= IsALL ? checked='checked' : '' # value='2' class=\"IsCreatecheck_row check_row\" />" },
                    ];
                    //var selectedIds = {};
                    ...
                    $("#kgrdRole .k-grid-content.k-auto-scrollable").css("height", "350px");
                    ...
                    $("#btnSubmitRole").unbind().bind('click', function () {
                        ...
                        if (Role == "") {
                            $("#spnError").html("Please select Role then proceed.");
                            OpenModal("dvError", 900, "File Meta Data");
                            return false;
                        }
                        var form = $('#__AjaxAntiForgeryForm');
                        ...
                        $.post(SetUserRightsURL, { __RequestVerificationToken: token, FileID: FileID, UserRights: Role }, function (response) {
                            if (response.IsSuccess) {
                                $("#spnSucess").html(response.Message);
                                OpenModal("dvSucess", 900, "File Meta Data");
    ...
    $("#btnSearch").click(function () {
        ...
        if (dataitem != undefined) {
            ...
            if (text != '') {
                ...
                $("#spnError").html("Please enter search text.");
                OpenModal("dvError", 900, "File Meta Data");
            }
        }
        else {
