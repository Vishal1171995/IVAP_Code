...
{
    public class AadharCardValidation : ExtraValidationsBase
    {
  ...
  {9, 8, 7, 6, 5, 4, 3, 2, 1, 0}
       ...
       {7, 0, 4, 6, 9, 1, 3, 2, 5, 8}
        ...
        public override ValidationResponse Validate(BasicValidationBase Obj)
        {
            ...
            bool isValidnumber = validateVerhoeff(Obj.Value);
            Res.IsSuccess = false;
            Res.Message = Obj.DisplayName + " must be a valid aadhar number.";
